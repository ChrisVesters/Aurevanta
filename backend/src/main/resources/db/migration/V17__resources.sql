...
-- docs/design/resources-and-people.md measures what that costs: the same plan, the same durations, six slots — read
...
-- hierarchy is the cheap modelling choice chosen handles spent a whole work unpicking, in another
-- form.
...
create table resources (
    ...
    -- the next work rather than this one (docs/design/resources-and-people.md decision 1).
    ...
    -- which is calibration's "people are named and never ranked" arriving in a second place.
    --
...
-- is somebody's business and the id is what addresses one. Chosen handles is the change that paid
