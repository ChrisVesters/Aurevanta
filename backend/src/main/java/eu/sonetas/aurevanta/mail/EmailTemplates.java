...
public class EmailTemplates {
	...
	public EmailMessage verifyEmail(String recipient, String displayName, String rawToken, Duration validFor) {
		...
		String body = """
				...
				The link works once and stops working after %d days. If you did not create
				an account, you can ignore this message — nothing has been set up in your
				name that anyone can use.
				""".formatted(displayName, link, validFor.toDays());
