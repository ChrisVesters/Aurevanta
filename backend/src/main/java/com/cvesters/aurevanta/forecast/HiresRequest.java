 ...
 *
 * <p>
 * <strong>One pool at a time, and no search.</strong> M7 searches because a list of cuts
 * is combinatorial and its budget has to be stated; this is a question with a handful of
 * answers, and a search over hiring plans would be a staffing tool rather than a
 * forecast. Which pool to ask about is a judgement about people and money that this
 * server holds none of — the same reason the candidates for a cut come from the caller.
 *
