 ...
 *
 * <p>
 * Worth refusing rather than storing and shrugging at. The column exists so that M8 can
 * ask whether changing the question changed how often a band contained the truth, which
 * is the only evidence M5's own claim can ever have — and an answer partitioned by a
 * value nobody ever collected under is worse than no partition, because it looks like
 * data.
 */
