 ...
 * opens the tool — so M3 forecasts what is estimated and says how much it left out. M2's
 * half of that decision is making the number computable and visible, which is this.
 *
 ...
 * person's range is enough to count — whether several estimators agree is a question M3
 * asks, and answering it here would make coverage mean two things at once.
 */
